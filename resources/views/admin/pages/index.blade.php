                ...
                <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-xs-12">
                  <table class="table table-striped">
                    ...
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{asset('image/flags/US.png')}}">
                        </div>
                      </td>
                      <td>USA</td>
                      <td class="text-right">
                    ...
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{asset('image/flags/DE.png')}}">
                        </div>
                      </td>
                      <td>Germany</td>
                      <td class="text-right">
                    ...
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{asset('image/flags/AU.png')}}">
                        </div>
                      </td>
                      <td>Australia</td>
                      <td class="text-right">
                    ...
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{asset('image/flags/GB.png')}}">
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{asset('image/flags/RO.png')}}">
                        </div>
                      </td>
                      <td>Romania</td>
                      <td class="text-right">
                    ...
                    <tr>
                      <td>
                        <div class="flag">
                          <img src="{{asset('image/flags/BR.png')}}">
                        </div>
                      </td>
                      <td>Brasil</td>
                      <td class="text-right">
            ...
            <div class="card-body">
              ...
              <div class="fluid-container">
                <div class="row ticket-card mt-3 pb-2 border-bottom">
                  <div class="col-1">
                    <img class="img-sm rounded-circle" src="{{asset('image/faces/face1.jpg')}}" alt="profile image">
                  </div>
                ...
                <div class="row ticket-card mt-3 pb-2 border-bottom">
                  <div class="col-1">
                    <img class="img-sm rounded-circle" src="{{asset('image/faces/face2.jpg')}}" alt="profile image">
                  </div>
                  <div class="ticket-details col-9">
                    <div class="d-flex">
                ...
                <div class="row ticket-card mt-3 pb-2 border-bottom">
                  <div class="col-1">
                    <img class="img-sm rounded-circle" src="{{asset('image/faces/face3.jpg')}}" alt="profile image">
                  </div>
                  <div class="ticket-details col-9">
                    <div class="d-flex">
                ...
                <div class="row ticket-card mt-3 pb-2 border-bottom">
                  <div class="col-1">
                    <img class="img-sm rounded-circle" src="{{asset('image/faces/face4.jpg')}}" alt="profile image">
                  </div>
                  <div class="ticket-details col-9">
                    <div class="d-flex">
                ...
                <div class="row ticket-card mt-3 pb-2">
                  <div class="col-1">
                    <img class="img-sm rounded-circle" src="{{asset('image/faces/face5.jpg')}}" alt="profile image">
                  </div>
                  <div class="ticket-details col-9">
                    <div class="d-flex">
